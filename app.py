...
class Database(object):
    def __init__(self):
        self.conn = sqlite3.connect('Realm17.db')
...
def fetch_users():
    with sqlite3.connect('Realm17.db') as conn:
        cursor = conn.cursor()
...
def init_user_table():
    conn = sqlite3.connect('Realm17.db')
    ...
    print("Realm17.db table successfully")
    conn.close()
...
def init_products_table():
    ...
    print("Realm17.db table created successfully")
...
def init_admin_table():
    with sqlite3.connect('Realm17.db') as conn:
        ...
        print("Realm17.db admin table created successfully")
